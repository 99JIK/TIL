...
This study aims to:
- Understand the characteristics of TBCG techniques.
- Identify research trends.
- Assess the importance of MDE in code synthesis.
- Evaluate expressiveness, performance, and scalability of various tools.

Key findings:
- **Model-based tools** offer more expressiveness.
- **Code-based tools** perform much faster.
- **Xtend2** offers the best compromise between expressiveness and performance.

<!-- truncate -->

Source: [U Montreal Scholaris](https://umontreal.scholaris.ca/items/1d018af3-d7cd-4306-aeec-af669af55131)
