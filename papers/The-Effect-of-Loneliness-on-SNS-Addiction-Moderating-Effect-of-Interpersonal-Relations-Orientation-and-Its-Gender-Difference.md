...
$$
Y (\text{SNS 중독}) = \beta_0 + \beta_1 (\text{외로움}) + \beta_2 (\text{대인관계 지향성}) + \beta_3 (\text{외로움} \times \text{대인관계 지향성}) + \epsilon
$$
...
* **조절 효과**: 전체 집단 및 여성 집단에서는 대인관계 지향성의 조절 효과가 유의했으나($\Delta R^2 = .03, p < .05$), 남성 집단에서는 유의하지 않았다.

| 집단  | 외로움 영향 ($\beta$) | 대인관계 지향성 영향 ($\beta$) | 상호작용 유의성       |
| --- | ---------------- | --------------------- | -------------- |
...
## Key Figures
![Figure 1](img/Pasted%20image%2020260428170023.png)
- **Fig. 1**: 여성 대학생 집단에서 대인관계 지향성이 높을수록(High) 외로움 증가에 따른 SNS 중독 경향성의 상승 폭이 저집단(Low)보다 가파름을 보여주는 상호작용 도표.
![Table 2](img/Pasted%20image%2020260428165954.png)
- **Table 2**: 남녀 간 상관계수 차이 제시. 남성의 경우 외로움과 SNS 중독 총점 간 상관($r = .34$)이 여성($r = .19$)보다 높게 나타남.
...
- **DOI**: [10.15842/kjcp.2017.36.2.002](https://doi.org/10.15842/kjcp.2017.36.2.002)
- **BibTeX key**: `lee2017loneliness`
