...
- **Design Complexity**: How easy it is to model the task.
- **Maintainability**: The effort required to modify or extend the policy.
- **Performance**: The robustness and reactivity of the robot during execution.

The study concludes that BTs offer superior scalability and maintainability for complex, multi-stage robotic tasks.

<!-- truncate -->

Source: [IEEE Xplore (10106642)](https://ieeexplore.ieee.org/document/10106642/)
