...
### 모델 아키텍처 / 방법론
![Figure 1](img/Pasted%20image%2020250924104313.png)
![Figure 2](img/Pasted%20image%2020250924104348.png)
![Figure 4](img/Pasted%20image%2020250924105253.png)
...
- **알고리즘**: 다차원 범위 검색 알고리즘은 MDTRIE를 순회하며 검색 범위에 해당하지 않거나 데이터 포인트가 없는 하위 트리를 조기에 제거(pruning)한다. 각 노드에서 비트 연산을 통해 유효한 자식 노드만 탐색하므로 매우 효율적으로 동작한다.
**Algorithm 1** Multi-demensional Range Search(Pseudo Code)
```Python
...
### 실험 결과
![Figure 5](img/Pasted%20image%2020250924105346.png)
![Figure 6](img/Pasted%20image%2020250924105414.png)
![Figure 7, 8](img/Pasted%20image%2020250924105509.png)
![Figure 9, 10](img/Pasted%20image%2020250924105654.png)
