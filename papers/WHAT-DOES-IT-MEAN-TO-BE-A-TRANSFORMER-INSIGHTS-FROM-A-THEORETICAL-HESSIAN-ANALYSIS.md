...
date: "2024-01-01"
description: "Transformer 모델의 헤시안 분석을 통해 모델의 동작 원리와 특성을 이론적으로 분석한 연구"
keywords:
  [
    "Transformer",
    "Hessian Analysis",
...
### 연구 배경 및 설정 (Setup and Background)
...
### Self-Attention 헤시안의 정확한 구조 (Exact Structure of the Self-Attention Hessian)
...
### 트랜스포머 설계 요소가 헤시안에 미치는 영향 (Impact of Transformer Design Components on the Hessian)
