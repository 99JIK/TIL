...
The LLM-GP-BT technique processes robot task commands expressed in human natural language and converts them into accurate and reliable BT-based task plans in a computationally efficient and user-friendly manner. The proposed technique is systematically developed and validated through simulation experiments.

<!-- truncate -->

## Features
- **LLM-GP-BT Technique**: Integration of LLM and Genetic Programming.
- **Natural Language Processing**: Converts human commands into BT plans.
- **Reliability and Efficiency**: Focused on creating accurate and computationally efficient policies.

Source: [arXiv:2502.07772](https://arxiv.org/abs/2502.07772)
