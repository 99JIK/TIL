...
- **Intuitive Programming**: No need for manual coding of the task tree.
- **Explainability**: The resulting BT provides a clear rationale for the robot's actions.
- **Refinement**: Users can easily manually adjust the learned BT to handle corner cases.

<!-- truncate -->

Source: [IEEE Xplore (8794104)](https://ieeexplore.ieee.org/document/8794104/)
