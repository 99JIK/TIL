...
## Key Contributions
- **Automated Design**: Reduces the manual effort required to create complex BTs.
- **Human-Readable Policies**: Ensures that the acquired policies remain understandable and verifiable by human operators.
- **Robotic Applications**: Validated through experiments in various robot control scenarios.

Source: [IEEE Xplore (8594083)](https://ieeexplore.ieee.org/document/8594083/)
