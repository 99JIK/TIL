---
title: LLM 기초 개념
description: 언어 모델·토크나이제이션·임베딩·Transformer·학습 목적함수 등 LLM 핵심 개념 정리.
tags: [research, llm, nlp, deep-learning]
sidebar_position: 2
last_update:
  date: 2026-04-23
---
...
언어 모델·토크나이제이션·임베딩·Transformer·학습 목적함수 등 LLM 핵심 개념 정리.

> 경북대학교 대학원 인공지능융합응용(GRAD0732), 이성현 교수님 강의 정리.
