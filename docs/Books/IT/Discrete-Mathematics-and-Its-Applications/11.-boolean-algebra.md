...
$$B=\{0,1\}$$이라고 할 때 $$B^n=\{(x_1,x_2,\dots,x_n)\mid x_i\in B \text{ for }1\leq i\leq n\}$$으로 0, 1의 모든 가능한 $$n$$-tuple의 Set이 된다.\
...
{/* 이미지 누락: ![Basic types of gates](./img/image (201).png) */}
...
{/* 이미지 누락: ![Gates with n inputs(AND, OR)](./img/image (202).png) */}
...
{/* 이미지 누락: ![Depic the circuit](./img/image (203).png) */}
...
{/* 이미지 누락: ![Half adder](./img/image (206).png) */}

{/* 이미지 누락: ![Full adder](./img/image (207).png) */}
...
{/* 이미지 누락: ![Adding two 3-bit integers with full and half adders](./img/image (208).png) */}
...
{/* 이미지 누락: ![Example circuit](./img/image (217).png) */}
...
{/* 이미지 누락: ![Example minimization circuit](./img/image (218).png) */}
...
{/* 이미지 누락: ![K-maps in three variables](./img/image (210).png) */}
...
{/* 이미지 누락: ![Blocks in K-maps in tree variables](./img/image (211).png) */}
...
{/* 이미지 누락: ![K-maps in four viarables](./img/image (213).png) */}
...
{/* 이미지 누락: ![Blocks in K-maps in four variables](./img/image (214).png) */}
