...
![Basic types of gates](./img/image (201).png)
...
<figure><img src="./img/image (202).png" alt=""><figcaption><p>Gates with <span class="math">n</span> inputs(AND, OR)</p></figcaption></figure>
...
<figure><img src="./img/image (203).png" alt=""><figcaption><p>Depic the circuit that produces the output <span class="math">xy+\bar{x}y</span></p></figcaption></figure>
...
![Half adder](./img/image (206).png)

![Full adder](./img/image (207).png)
...
![Adding two 3-bit integers with full and half adders](./img/image (208).png)
...
![Example circuit](./img/image (217).png)
...
![Example minimization circuit](./img/image (218).png)
...
![K-maps in three variables](./img/image (210).png)
...
![Blocks in K-maps in tree variables](./img/image (211).png)
...
![K-maps in four viarables](./img/image (213).png)
...
![Blocks in K-maps in four variables](./img/image (214).png)
