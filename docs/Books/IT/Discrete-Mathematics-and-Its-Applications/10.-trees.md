...
* Saturated Hydrocarbons and Trees\
  {/* 이미지 누락: ![](./img/image (63).png) */}
* Representing Organizations\
  {/* 이미지 누락: ![](./img/image (64).png) */}
* Computer File Systems\
  {/* 이미지 누락: ![](./img/image (65).png) */}
:::
...
{/* 이미지 누락: ![Nim](./img/image (54).png) */}

{/* 이미지 누락: ![Tic-tac-toe](./img/image (55).png) */}
...
{/* 이미지 누락: ![Universal Address System](./img/image (43).png) */}
...
{/* 이미지 누락: ![Preorder traversal](./img/image (45).png) */}

:::tip
Example

{/* 이미지 누락: ![](./img/image (44).png) */}\
...
{/* 이미지 누락: ![Inorder traversal](./img/image (46).png) */}

:::tip
Example

{/* 이미지 누락: ![](./img/image (47).png) */}\
...
{/* 이미지 누락: ![Postorder traversal](./img/image (48).png) */}

:::tip
Example

{/* 이미지 누락: ![](./img/image (49).png) */}\
...
{/* 이미지 누락: ![](./img/image (37).png) */}\
위 Graph의 DFS 결과

* Solution\
  {/* 이미지 누락: ![](./img/image (38).png) */}\
...
* Solution\
  ...
  {/* 이미지 누락: ![](./img/image (42).png) */}\
  Prim's algorithm을 사용한 결과물은 아래와 같다.\
  {/* 이미지 누락: ![](./img/image (41).png) */}
:::
