...
description: 책 "소프트웨어 스펙의 모든 것" 정리 — 요구사항·스펙 작성·협업 중심의 SW 문서화 실무 가이드.
tags: [writing, software-spec, requirements, book-note]
last_update:
  date: 2026-04-24
---
...
책 "소프트웨어 스펙의 모든 것" 정리 — 요구사항·스펙 작성·협업 중심의 SW 문서화 실무 가이드.
