...
description: 책 "Specification by Example" 정리 — 예시 기반 명세로 이해관계자·개발자·QA를 연결하는 핵심 실천법.
tags: [writing, software-spec, testing, bdd, book-note]
last_update:
  date: 2026-04-24
---
...
책 "Specification by Example" 정리 — 예시 기반 명세로 이해관계자·개발자·QA를 연결하는 핵심 실천법.
