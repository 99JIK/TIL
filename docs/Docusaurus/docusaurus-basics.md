---
title: Docusaurus 기초와 활용
description: Docusaurus의 특성·장단점, 프로젝트 생성, 구조·설정·플러그인 기초 개념 정리.
tags: [docusaurus, static-site-generator, react]
sidebar_position: 0
last_update:
  date: 2026-04-24
---
...
Docusaurus의 특성·장단점, 프로젝트 생성, 구조·설정·플러그인 기초 개념 정리.
