...
- 요약서
	- 개요
		> 본 발명은 섬유 방사 공정에서 목표 물성을 달성하기 위한 최적의 생산 조건(레시피)을 추천하는 시스템에 관한 것이다. 기존 방식은 과거 생산 이력에만 의존하여 데이터가 없는 신규 물성 대응이 어렵거나, 추천된 조건의 안정성을 보장하기 어려운 문제가 있었다. 이를 해결하기 위해 본 발명은 
	- 발명의 명칭
- 대표도면