...
- 시장성 및 기업화 전망
	...
	- 품질 보증 비용 절감: 변동성이 적은 레시ㅣ 운용을 통해 불량품 발생 확률을 낮춰 원가 경쟁력을 확보함
- 적용 및 응용분야
...
- 요약서
	- 개요
		> 본 발명은 섬유 방사 공정에서 목표 물성을 달성하기 위한 최적의 생산 조건(레시피)을 추천하는 시스템에 관한 것이다. 기존의 최적화 방식은 목표값 달성에만 치중하여, 실제 공정 적용 시 외부 환경 변화에 취약하거나, 안정적으로 목표 물성을 도달하는 확률을 높일 수 없는 문제가 있었다. 이를 해결하기 위해 본 발명은 예측 모델의 레시피가 집중된 고밀도 군집을 찾아내어 설비 운용 신뢰성을 확보하고, 
	- 발명의 명칭
- 대표도면