...
![PDF p.5: Facial nerve (얼굴 신경) 경로 다이어그램]
...
![PDF p.6: 뇌 다이어그램 (Motor cortex 및 Amygdala 위치)]
...
![PDF p.10: Valence 및 Arousal의 2D 감정 모델 차트]
...
![PDF p.14: 얼굴 근육 해부도 (Frontalis, Zygomaticus, Corrugator supercilii 등)]
