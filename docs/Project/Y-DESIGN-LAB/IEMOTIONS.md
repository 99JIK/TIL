...
![PDF p.16: 행복(AU 6, 12, 25)과 놀람(AU 1, 2, 5, 10)의 Action Unit (AU) 예시]
* 표정 카테고리:
...
**자동 안면 코딩의 기술적 단계**
![PDF p.20: 자동 안면 코딩 워크플로우 (Input Video -> Face Detection -> Feature Detection -> Feature Classification)]
