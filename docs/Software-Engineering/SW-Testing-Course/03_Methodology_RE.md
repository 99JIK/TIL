---
title: "Week 3 — 개발 방법론 & 요구사항 분석"
description: 소프트웨어 테스팅 및 검증 강의(COSE0719) Week 3. SW 프로세스·개발 방법론·요구사항 도출.
tags: [software-testing, course-note, methodology, requirements]
sidebar_position: 3
last_update:
  date: 2026-04-23
---
...
소프트웨어 테스팅 및 검증 강의(COSE0719) Week 3. SW 프로세스·개발 방법론·요구사항 도출.
