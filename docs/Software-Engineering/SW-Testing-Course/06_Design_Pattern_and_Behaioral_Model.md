---
title: "Week 6 — 디자인 패턴 & 행위 모델"
description: 소프트웨어 테스팅 및 검증 강의(COSE0719) Week 6. GoF 디자인 패턴·시퀀스 다이어그램.
tags: [software-testing, course-note, design-pattern, sequence-diagram]
sidebar_position: 6
last_update:
  date: 2026-04-23
---
...
소프트웨어 테스팅 및 검증 강의(COSE0719) Week 6. GoF 디자인 패턴·시퀀스 다이어그램.
