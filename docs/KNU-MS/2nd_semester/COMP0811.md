...
강의 시작을 알리며 다양한 언어로 "만나서 반갑습니다"라는 인사를 전한다.
...
Noam Brown은 "모든 사람은 각기 다른 시점에 자신의 Lee Sedol moment를 갖게 될 것"이라고 말했다.
...
이후 그들은 Alex Krizhevsky와 함께 2012년 "ImageNet Classification with Deep Convolutional Neural Networks" (AlexNet)를 발표했다.
...
- LLM Policy: 과제 수행 시 ChatGPT 등 LLM 사용을 허용한다.
